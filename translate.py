...
# you can then use the .append method to append all your proteins onto an amino_acids_list. 
...
def get_complement(sequence):
    ...
    'UACG'
    """
    dict = {"A":"U", "U":"A", "C":"G", "G":"C", "a":"u", "u":"a", "c":"g", "g":"c"}
    complement = ""    
    if sequence == "":
        return ""
    else:
        for base in sequence:
            complement += dict[base]
...
def reverse_and_complement(sequence):
    ...
    if sequence == "":
        ...
        for base in sequence:
            reverse_and_complement += dict[base]
        return reverse_and_complement.upper() [::-1]
